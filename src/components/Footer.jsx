const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-primary-600 to-secondary-600 text-white mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Portfolio & Blog</h3>
            <p className="text-primary-100">
              Showcase your work and share your thoughts with the world.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/projects" className="text-primary-100 hover:text-white transition-colors">
                  Projects
                </a>
              </li>
              <li>
